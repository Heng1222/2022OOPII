...
class myJFrame6 extends JFrame implements ListSelectionListener{
    ...
    String mountain[] = {"黃珊珊", "龜山", "大肚肚山", "八卦山", "阿里山", "半屏山", "好山好水", "鯉魚山", "壽豐山", "抹茶山"};
    public myJFrame6(){
        ...
        JScrollPane jsp2 = new JScrollPane(jta1,ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
