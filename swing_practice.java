                ...
                for(int i = 0 ; i < text.length() ; i++){
                    ...
                    if(i == text.length()-1){
                        ...
                        while(str.contains('x')||str.contains('/')){
                            if(str.contains('x')){
                                integer.add(str.indexOf('x')+2,integer.get(str.indexOf('x'))*integer.get(str.indexOf('x')+1));
                                integer.remove(str.indexOf('x')+1);
                                integer.remove(str.indexOf('x'));
                                str.remove(str.indexOf('x'));
                            }
                            if(str.contains('/')){
                                integer.add(str.indexOf('/')+2,integer.get(str.indexOf('/'))/integer.get(str.indexOf('/')+1));
